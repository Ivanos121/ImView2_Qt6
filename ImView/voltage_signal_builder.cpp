...
#include "base.h"
#include "ui_voltage_signal_builder.h"
...
Voltage_signal_builder::Voltage_signal_builder(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::Voltage_signal_builder)
{
    ui->setupUi(this);
    connect(ui->pushButtonPlot, &QPushButton::clicked, this, &Voltage_signal_builder::plotGraph);
    connect(ui->clearButton, &QPushButton::clicked, this, &Voltage_signal_builder::clearGraph);
    connect(ui->saveButton, &QPushButton::clicked, this, &Voltage_signal_builder::saveGraph);
    connect(ui->loadButton, &QPushButton::clicked, this, &Voltage_signal_builder::loadGraph);
    connect(ui->apply_pushButton, &QPushButton::clicked, this, &Voltage_signal_builder::apply_pushButton);
...
Voltage_signal_builder::~Voltage_signal_builder()
{
    delete ui;
}
...
void Voltage_signal_builder::loadGraph()
{
...
bool Voltage_signal_builder::loadPointsFromXml(const QString &fileName)
{
...
void Voltage_signal_builder::close_pushButton()
{
    close();
}

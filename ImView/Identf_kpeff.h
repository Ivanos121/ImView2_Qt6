...
struct Koeff_ad
{
    ...
    Koeff_ad() : koeff_3000(3000, {
        ...
        koeff_1500(1500, {
                             {1100, 1500, 2200, 3000, 4000, 5500, 7500, 11000, 15000, 18500},//Мощность двигателя
                             {1, 2, 3, 0.01, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
                             {1, 2, 3, 0.1, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
                             {1, 2, 3, 0.05, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
                             {1, 2, 3, 0.02, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
                             {1, 2, 3, 0.01, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
                             {1, 2, 3, 0.001, 5, 6, 6, 7, 8, 9}                //Коэффициент gd
                         }),
        koeff_1000(1000, {
                             {1100, 1500, 2200, 3000, 4000, 5500, 7500, 11000, 15000, 18500},//Мощность двигателя
                             {1, 2, 3, 4, 5, 6, 6, 7, 8, 9},               //Коэффициент gd
